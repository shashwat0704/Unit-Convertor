...
function convertStorage() {
  if (storageFromUnit.value == "bit") {
    ...
    if (storageToUnit.value == "mib") {
      storageToValue.value = storageFromValue.value / 8.389e6;
    }
    if (storageToUnit.value == "gib") {
      storageToValue.value = storageFromValue.value / 8.59e9;
    }
    if (storageToUnit.value == "tib") {
      storageToValue.value = storageFromValue.value / 8.796e12;
    }
    if (storageToUnit.value == "pib") {
      storageToValue.value = storageFromValue.value / 9.007e15;
    }
  }
  if (storageFromUnit.value == "byte") {
    ...
    if (storageToUnit.value == "mib") {
      storageToValue.value = storageFromValue.value / 1.049e6;
    }
    if (storageToUnit.value == "gib") {
      storageToValue.value = storageFromValue.value / 1.074e9;
    }
    if (storageToUnit.value == "tib") {
      storageToValue.value = storageFromValue.value / 1.1e12;
    }
    if (storageToUnit.value == "pib") {
      storageToValue.value = storageFromValue.value / 1.126e15;
    }
  }
